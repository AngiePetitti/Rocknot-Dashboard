...
export default function InsightsContent() {
  ...
  return (
    <div>
      ...
      {/* ── Ask Cleo (opens the floating chat available on every tab) ── */}
      <Card accentColor="#a78bfa" className="mb-5">
        <button
          onClick={() => window.dispatchEvent(new Event('open-cleo'))}
          className="w-full flex items-center gap-3 text-left"
        >
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-violet-100 to-pink-100 flex items-center justify-center text-lg shrink-0">💬</div>
          <div className="flex-1 min-w-0">
            <p className="text-xs font-bold text-gray-800">Ask Cleo</p>
            <p className="text-[10px] text-gray-400">Cleo is your AI analyst — she queries your live sales, ads, inventory & calendar data for whatever period your question needs, and shows the math. Now available on every tab via the 💬 bubble.</p>
          </div>
